    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == '\n' && currentLineIsBlank)
        {
          ...
          client.println("<HTML>");
          client.println("<HEAD>");
          client.println("<meta http-equiv=\"Refresh\" content=\"4; url=/Cleanroom Gd 11 & PET\" />");
          ...
          client.println("<TITLE>CleanRoom Gd 11 & PET</TITLE>");
          client.println("</HEAD>");
          client.println("<BODY align=\"center\" bgcolor=\"#34495E\">");
          client.println("<h1><p align=\"left\">Suhu dan RH CleanRoom Gd 11 & PET</h1>");
          client.println("<hr />");
          client.println("<br />");
          client.println("<br />");
